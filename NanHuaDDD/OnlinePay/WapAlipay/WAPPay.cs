...
namespace NanHuaDDD.OnlinePay.WapAlipay
{
    ...
    public class WAPPay
    {
        ...
        public WAPPay()
        {
            ...
            AlipayConfig.Partner = WebConfig.GetWebConfig("AlipayPartner", "");
            AlipayConfig.Private_key = WebConfig.GetWebConfig("AlipayWAPPrivateKey", "");
            AlipayConfig.Public_key = WebConfig.GetWebConfig("AlipayWAPPublicKey", "");
        ...
        public string PayFormString(string orderId = null, string subject = null, decimal total_fee = 0m)
        {
            ...
            LoggerFactory.Instance.Logger_Info("WAP向支付宝发出请求，发送的参数：" + str.ToString());
                ...
                if (verifyResult)//验证成功
                {
                    ...
                    try
                    {
                        ...
                        if (trade_status == "TRADE_FINISHED")
                        {
                            ...
                            LoggerFactory.Instance.Logger_Info("WAP支付宝回调成功，订单号：" + out_trade_no + "，交易号：" + trade_no);
                        ...
                        else if (trade_status == "TRADE_SUCCESS")
                        {
                            ...
                            LoggerFactory.Instance.Logger_Info(str.ToString());
                            notifySuccess(out_trade_no, trade_no);
                            Response.Write("success");
                        }
                        else
